            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ trans('main_trans.Wishlist') }} </li>
            ...
            <div class="container">
                <div class="d-flex align-items-center px-3 py-2 border mb-4">
                    <div class="text-start">
                        <h4 class="mb-0 h4 fw-bold">{{ trans('main_trans.Wishlist') }} (10{{ trans('main_trans.Items') }})
                        </h4>
                    </div>
                    <div class="ms-auto">
                        <button
